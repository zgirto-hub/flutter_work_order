...
class _AddWorkOrderScreenState extends State<AddWorkOrderScreen> {
  ...
  void initState() {
    ...
    if (widget.workOrder != null) {
      ...
      departmentController.text = widget.workOrder!.department;
      ...
      // For new work orders, auto-fill department and mobile for requesters
      departmentController.text = 'General';
  ...
  Future<void> _loadUserProfile(String email) async {
    ...
    try {
      ...
      if (res.statusCode == 200 && mounted) {
        ...
        if (emp != null) {
          setState(() {
            departmentController.text = (emp['department'] ?? 'General').toString();
  ...
  Widget _buildComposeBar() {
    ...
    return Container(
      color: AppColors.bgSurface,
      // CRITICAL FIX: Add bottom padding based on keyboard inset
